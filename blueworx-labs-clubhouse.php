...
define( 'BLUEWORX_LABS_CLUBHOUSE_VERSION', '0.73.1' );
...
require_once BLUEWORX_LABS_CLUBHOUSE_DIR . 'includes/admin/class-pages-controller.php';
require_once BLUEWORX_LABS_CLUBHOUSE_DIR . 'includes/admin/class-blocks-controller.php';
...
function blueworx_labs_clubhouse_init() {
	...
	Blueworx_Clubhouse_Pages_Controller::register();
	Blueworx_Clubhouse_Blocks_Controller::register();
