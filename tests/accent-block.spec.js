...
test('the hero scrim stays neutral so club photos are not colour-cast @preview', async ({ page }) => {
  await page.goto('?clubhouse_page=home');
...
test('switching the accent re-themes the backbone through the real engine @preview', async ({ page }) => {
  await page.goto('?clubhouse_page=home');
