 ...
 *
 * Visibility used to be a sixth item, counted once the owner had saved the
 * Setup screen. The tab it referred to has gone — what a page shows is now the
 * blocks it is composed of — so progress no longer counts a screen that is not
 * there.
 *
